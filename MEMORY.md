...
- **Имя:** Юрий
- **Постоянные сведения о сфере деятельности, роли и конкретных проектах:** хранятся в соответствующих специализированных контурах.
...
- Профессиональные сведения об активных проектах не хранятся на универсальном уровне.
- Контур управления бизнесом: `agents/executive-director/`.
- Творческий контур: `agents/authors-workshop/`.
